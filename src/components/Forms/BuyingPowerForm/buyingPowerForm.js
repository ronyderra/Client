                    ...
                    <Grid container>
                        <Grid item xs={6}>
                            ...
                            <Controls.Select
                                ...
                                value={values.action}
                                onChange={handleInputChange}
                                options={dataCollection.getActionCollection()}
                                error={errors.action}
                            />
                            <Controls.Input
                                label="Amount"
                        ...
                        <Grid item xs={6}>
                            <Controls.RadioGroup
                                ...
                                onChange={handleInputChange}
                                items={dataCollection.platformItems}
                            />
                            <Controls.Select
                                name="currency"
                                label="Currency"
                                ...
                                onChange={handleInputChange}
                                options={dataCollection.getCurrencyCollection()}
                            ...
                            />
                              <Controls.Select
                                ...
                                value={values.reason}
                                onChange={handleInputChange}
                                options={dataCollection.getReasonCollection()}
                            />
                            <div>
                                <Controls.Button
                                    type="submit"
